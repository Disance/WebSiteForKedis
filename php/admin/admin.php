<?php
 ...
 if(isset($_GET['del'])){
    $id = $_GET['del'];
    $query = mysqli_query($link ,"DELETE FROM `reviews` WHERE id=$id");
...
<?php
    ...
    <div class="container">
        ...
        while($review = mysqli_fetch_assoc($result)){
            ...
            <h3>Оценка: <?php echo $review['Grade']?> <svg style="position: relative;
            ...
            <a style="float: right; position: relative; bottom: 30px;" class="delete-vector" href="?del=<?php echo $review['id']?>"><img width="30px" src="/vector/delete.png" alt=""></a>
